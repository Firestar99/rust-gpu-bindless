use crate::generic::backing::table::{FrameGuard, TableSync};
use crate::generic::descriptor::buffer_table::{BufferTable, BufferTableAccess};
use crate::generic::descriptor::descriptor_counts::DescriptorCounts;
use crate::generic::descriptor::image_table::{ImageTable, ImageTableAccess};
use crate::generic::descriptor::sampler_table::{SamplerTable, SamplerTableAccess};
